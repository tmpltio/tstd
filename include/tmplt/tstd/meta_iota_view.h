...
class meta_iota_view : public std::ranges::view_interface<meta_iota_view<Count>>
{
    ...
    class iterator
    {
        using index_t = least_unsigned_t<Count>;
...
public:
    static constexpr std::random_access_iterator auto begin() noexcept(std::is_nothrow_default_constructible_v<iterator>)
    {
        return iterator{};
    }

    static constexpr std::sentinel_for<std::ranges::iterator_t<meta_iota_view>> auto end() noexcept(std::is_nothrow_copy_constructible_v<std::default_sentinel_t>)
    {
...
{
public:
    [[nodiscard]] static constexpr auto operator()() noexcept(std::is_nothrow_default_constructible_v<meta_iota_view<Count>>)
    {
